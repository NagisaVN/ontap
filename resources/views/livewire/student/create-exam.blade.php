<div class="p-6 max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 space-y-5">
        ...
        <button type="button" wire:click="batDauThi"
            ...
            wire:target="batDauThi"
            @disabled(!$canStart)
            class="relative w-full h-11 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed rounded-xl text-white text-sm font-bold transition-colors text-center">
            <span wire:loading.remove wire:target="batDauThi" class="inline-flex items-center justify-center gap-2 w-full">
            ...
            <span
                wire:loading.flex
                wire:target="batDauThi"
                class="absolute inset-0 items-center justify-center gap-2"
            >
                <svg class="animate-spin h-4 w-4 shrink-0 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
