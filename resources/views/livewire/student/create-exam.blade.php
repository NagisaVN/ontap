    ...
    <div class="sp-card p-8 text-center">
        ...
        <div class="text-left space-y-4">
            ...
            <button wire:click="batDauThi"
                ...
                {{-- Default state --}}
                <span wire:loading.remove wire:target="batDauThi" class="flex items-center gap-2">
                    🚀 Bắt đầu thi
                </span>

                {{-- Loading state --}}
                <span wire:loading wire:target="batDauThi" class="flex flex-col items-center gap-1 w-full" style="display:none">
                    <span class="text-center w-full">Đang tạo đề...</span>
