...
<div class="relative">
    ...
    <div class="p-6 max-w-5xl mx-auto space-y-5">
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <div class="relative">
                <select wire:model.live="filterSubject" class="h-9 pl-3 pr-8 appearance-none bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/30">
            ...
            <div class="relative">
                <select wire:model.live="filterDifficulty" class="h-9 pl-3 pr-8 appearance-none bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/30">
            ...
            <div class="flex items-center gap-2 ml-auto pl-3 border-l border-slate-200">
                <span class="text-sm text-slate-600">Đã chọn <strong>{{ count($selectedIds) }}</strong></span>
                <button wire:click="deleteSelected" wire:confirm="Xóa {{ count($selectedIds) }} câu hỏi đã chọn?"
    ...
    {{-- ═══════════════════ EDIT MODAL (trong cùng root div) ═══════════════════ --}}
    @if($showEditModal)
    ...
    <div class="w-full max-w-2xl bg-white rounded-2xl shadow-2xl flex flex-col max-h-[90vh]">
            ...
            <div>
                <div class="flex items-center justify-between mb-2">
                    <div>
                        ...
                        <span class="text-xs text-slate-400 ml-1">(bấm ◉ để đặt đáp án đúng)</span>
                    </div>
                ...
                <div class="space-y-2.5">
                    ...
                    <div class="flex items-center gap-2.5 group">
                        ...
                        <button wire:click="removeOption({{ $i }})" type="button"
                                class="opacity-0 group-hover:opacity-100 w-6 h-6 rounded flex items-center justify-center text-slate-300 hover:text-rose-500 hover:bg-rose-50 transition-all">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-t border-slate-200 bg-slate-50 flex-shrink-0">
            ...
            <button wire:click="saveEdit"
                    ...
                    class="h-10 px-6 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-60 rounded-xl text-sm font-semibold text-white flex items-center gap-2 transition-colors">
