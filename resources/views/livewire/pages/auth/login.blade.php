...
<div x-data="{ showPass: false }" class="space-y-6">
    ...
    <form wire:submit="login" class="space-y-4">
        ...
        <button type="submit"
            ...
            {{-- Loading state --}}
            <span wire:loading wire:target="login" class="flex flex-col items-center gap-1 w-full" style="display:none">
                <span class="text-center w-full">Đang xử lý...</span>
                <svg class="w-4 h-4 animate-spin mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
