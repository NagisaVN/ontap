<div>
  ...
  <form wire:submit="register" class="space-y-4">
    ...
    <button
      ...
      class="relative w-full h-10 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-70 rounded-lg text-white text-sm font-semibold transition-colors text-center mt-2"
    >
