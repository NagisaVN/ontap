...
<body class="antialiased font-sans text-slate-900 transition-colors duration-300" :class="dark ? 'bg-slate-900 text-slate-100' : 'bg-slate-50'">
    ...
    <div x-data="{
        ...
        <aside id="app-sidebar"
            class="flex flex-col border-r shrink-0 overflow-hidden w-64
        ...
        >
            ...
            <div :class="collapsed ? 'justify-center px-0' : 'px-5'" class="flex items-center h-16 border-b transition-all duration-300" :class="dark ? 'border-slate-700' : 'border-slate-100'">
                <a href="/" class="flex items-center gap-2 min-w-0" style="text-decoration:none;">
                    ...
                    <span x-show="!collapsed" x-transition:enter="transition-opacity ease-out duration-200 delay-[180ms]" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-in duration-[80ms]" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="font-bold text-lg tracking-tight whitespace-nowrap" :class="dark ? 'text-white' : 'text-slate-900'">SmartPrep</span>
                </a>
            </div>
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                ...
                @auth
                    {{-- STUDENT SECTION --}}
                    @can('student')
                        <div x-show="!collapsed" x-transition:enter="transition-opacity ease-out duration-200 delay-[180ms]" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-in duration-[80ms]" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="px-2 mt-4 mb-2 text-xs font-bold uppercase tracking-wider" :class="dark ? 'text-slate-500' : 'text-slate-400'">Học tập</div>
                        ...
                        <a href="{{ route('dashboard') }}" wire:navigate :title="collapsed ? 'Tổng quan' : null"
                           ...
                           :class="[collapsed ? 'justify-center' : '', dark ? '{{ request()->routeIs('dashboard') ? 'bg-indigo-500/10 text-indigo-400' : 'text-slate-400 hover:bg-slate-700/50 hover:text-slate-200' }}' : '{{ request()->routeIs('dashboard') ? 'bg-indigo-50 text-indigo-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}']">
                            ...
                            <span x-show="!collapsed" x-transition:enter="transition-opacity ease-out duration-200 delay-[180ms]" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-in duration-[80ms]" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="truncate overflow-hidden whitespace-nowrap">Tổng quan</span>
                        </a>
                        ...
                        <a href="{{ route('student.thi') }}" wire:navigate.hover :title="collapsed ? 'Làm bài thi' : null"
                           ...
                           :class="[collapsed ? 'justify-center' : '', dark ? '{{ request()->routeIs('student.thi') ? 'bg-indigo-500/10 text-indigo-400' : 'text-slate-400 hover:bg-slate-700/50 hover:text-slate-200' }}' : '{{ request()->routeIs('student.thi') ? 'bg-indigo-50 text-indigo-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}']">
                            ...
                            <span x-show="!collapsed" x-transition:enter="transition-opacity ease-out duration-200 delay-[180ms]" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-in duration-[80ms]" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="truncate overflow-hidden whitespace-nowrap">Làm bài thi</span>
                        </a>
                        ...
                        <a href="{{ route('student.on-tap') }}" wire:navigate :title="collapsed ? 'Ôn điểm yếu' : null"
                           ...
                           :class="[collapsed ? 'justify-center' : '', dark ? '{{ request()->routeIs('student.on-tap') ? 'bg-indigo-500/10 text-indigo-400' : 'text-slate-400 hover:bg-slate-700/50 hover:text-slate-200' }}' : '{{ request()->routeIs('student.on-tap') ? 'bg-indigo-50 text-indigo-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}']">
                            ...
                            <span x-show="!collapsed" x-transition:enter="transition-opacity ease-out duration-200 delay-[180ms]" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-in duration-[80ms]" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="truncate overflow-hidden whitespace-nowrap">Ôn điểm yếu</span>
                        </a>
                        ...
                        <a href="{{ route('student.history') }}" wire:navigate :title="collapsed ? 'Lịch sử' : null"
                           ...
                           :class="[collapsed ? 'justify-center' : '', dark ? '{{ request()->routeIs('student.history') ? 'bg-indigo-500/10 text-indigo-400' : 'text-slate-400 hover:bg-slate-700/50 hover:text-slate-200' }}' : '{{ request()->routeIs('student.history') ? 'bg-indigo-50 text-indigo-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}']">
                            ...
                            <span x-show="!collapsed" x-transition:enter="transition-opacity ease-out duration-200 delay-[180ms]" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-in duration-[80ms]" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="truncate overflow-hidden whitespace-nowrap">Lịch sử</span>
                        </a>
                    @endcan
                    ...
                    {{-- TEACHER SECTION --}}
                    @can('teacher')
                        <div x-show="!collapsed" x-transition:enter="transition-opacity ease-out duration-200 delay-[180ms]" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-in duration-[80ms]" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="px-2 mt-6 mb-2 text-xs font-bold uppercase tracking-wider" :class="dark ? 'text-slate-500' : 'text-slate-400'">Quản lý GV</div>
                        ...
                        <a href="{{ route('teacher.dashboard') }}" wire:navigate :title="collapsed ? 'Tổng quan GV' : null"
                           ...
                           :class="[collapsed ? 'justify-center' : '', dark ? '{{ request()->routeIs('teacher.dashboard') ? 'bg-emerald-500/10 text-emerald-400' : 'text-slate-400 hover:bg-slate-700/50 hover:text-slate-200' }}' : '{{ request()->routeIs('teacher.dashboard') ? 'bg-emerald-50 text-emerald-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}']">
                            ...
                            <span x-show="!collapsed" x-transition:enter="transition-opacity ease-out duration-200 delay-[180ms]" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-in duration-[80ms]" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="truncate overflow-hidden whitespace-nowrap">Dashboard</span>
                        </a>
                        ...
                        <a href="{{ route('teacher.questions') }}" wire:navigate :title="collapsed ? 'Câu hỏi' : null"
                           ...
                           :class="[collapsed ? 'justify-center' : '', dark ? '{{ request()->routeIs('teacher.questions') ? 'bg-emerald-500/10 text-emerald-400' : 'text-slate-400 hover:bg-slate-700/50 hover:text-slate-200' }}' : '{{ request()->routeIs('teacher.questions') ? 'bg-emerald-50 text-emerald-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}']">
                            ...
                            <span x-show="!collapsed" x-transition:enter="transition-opacity ease-out duration-200 delay-[180ms]" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-in duration-[80ms]" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="truncate overflow-hidden whitespace-nowrap">Câu hỏi</span>
                        </a>
                        ...
                        <a href="{{ route('teacher.create-question') }}" wire:navigate :title="collapsed ? 'Thêm câu hỏi' : null"
                           ...
                           :class="[collapsed ? 'justify-center' : '', dark ? '{{ request()->routeIs('teacher.create-question') ? 'bg-emerald-500/10 text-emerald-400' : 'text-slate-400 hover:bg-slate-700/50 hover:text-slate-200' }}' : '{{ request()->routeIs('teacher.create-question') ? 'bg-emerald-50 text-emerald-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}']">
                            ...
                            <span x-show="!collapsed" x-transition:enter="transition-opacity ease-out duration-200 delay-[180ms]" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-in duration-[80ms]" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="truncate overflow-hidden whitespace-nowrap">Thêm câu hỏi</span>
                        </a>
                        ...
                        <a href="{{ route('teacher.ocr') }}" wire:navigate :title="collapsed ? 'OCR Upload' : null"
                           ...
                           :class="[collapsed ? 'justify-center' : '', dark ? '{{ request()->routeIs('teacher.ocr') ? 'bg-emerald-500/10 text-emerald-400' : 'text-slate-400 hover:bg-slate-700/50 hover:text-slate-200' }}' : '{{ request()->routeIs('teacher.ocr') ? 'bg-emerald-50 text-emerald-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}']">
                            ...
                            <span x-show="!collapsed" x-transition:enter="transition-opacity ease-out duration-200 delay-[180ms]" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-in duration-[80ms]" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="truncate overflow-hidden whitespace-nowrap">OCR Upload</span>
                        </a>
                        ...
                        <a href="{{ route('teacher.exam-builder') }}" wire:navigate :title="collapsed ? 'Tạo đề thi' : null"
                           ...
                           :class="[collapsed ? 'justify-center' : '', dark ? '{{ request()->routeIs('teacher.exam-builder') ? 'bg-emerald-500/10 text-emerald-400' : 'text-slate-400 hover:bg-slate-700/50 hover:text-slate-200' }}' : '{{ request()->routeIs('teacher.exam-builder') ? 'bg-emerald-50 text-emerald-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}']">
                            ...
                            <span x-show="!collapsed" x-transition:enter="transition-opacity ease-out duration-200 delay-[180ms]" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-in duration-[80ms]" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="truncate overflow-hidden whitespace-nowrap">Tạo đề thi</span>
                        </a>
                        ...
                        <a href="{{ route('teacher.reports') }}" wire:navigate :title="collapsed ? 'Báo cáo' : null"
                           ...
                           :class="[collapsed ? 'justify-center' : '', dark ? '{{ request()->routeIs('teacher.reports') ? 'bg-emerald-500/10 text-emerald-400' : 'text-slate-400 hover:bg-slate-700/50 hover:text-slate-200' }}' : '{{ request()->routeIs('teacher.reports') ? 'bg-emerald-50 text-emerald-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}']">
                            ...
                            <span x-show="!collapsed" x-transition:enter="transition-opacity ease-out duration-200 delay-[180ms]" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-in duration-[80ms]" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="truncate overflow-hidden whitespace-nowrap">Báo cáo</span>
                        </a>
                        ...
                        <a href="{{ route('teacher.pending') }}" wire:navigate :title="collapsed ? 'Chờ duyệt' : null"
                           ...
                           :class="[collapsed ? 'justify-center' : '', dark ? '{{ request()->routeIs('teacher.pending') ? 'bg-emerald-500/10 text-emerald-400' : 'text-slate-400 hover:bg-slate-700/50 hover:text-slate-200' }}' : '{{ request()->routeIs('teacher.pending') ? 'bg-emerald-50 text-emerald-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}']">
                            <div class="flex items-center gap-3">
                                ...
                                <span x-show="!collapsed" x-transition:enter="transition-opacity ease-out duration-200 delay-[180ms]" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-in duration-[80ms]" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="truncate overflow-hidden whitespace-nowrap">Chờ duyệt</span>
                            </div>
                            @php $choDuyet = \App\Models\Question::choDuyet()->count(); @endphp
                            @if($choDuyet > 0)
                                <span x-show="!collapsed" class="inline-flex items-center justify-center w-5 h-5 text-[10px] font-bold text-white bg-rose-500 rounded-full">{{ $choDuyet }}</span>
                            @endif
                        </a>
                    @endcan
                    ...
                    {{-- ADMIN SECTION --}}
                    @can('admin')
                        <div x-show="!collapsed" x-transition:enter="transition-opacity ease-out duration-200 delay-[180ms]" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-in duration-[80ms]" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="px-2 mt-6 mb-2 text-xs font-bold uppercase tracking-wider" :class="dark ? 'text-slate-500' : 'text-slate-400'">Admin</div>
                        ...
                        <a href="{{ route('admin.dashboard') }}" wire:navigate :title="collapsed ? 'Quản trị hệ thống' : null"
                           ...
                           :class="[collapsed ? 'justify-center' : '', dark ? '{{ request()->routeIs('admin.dashboard') ? 'bg-rose-500/10 text-rose-400' : 'text-slate-400 hover:bg-slate-700/50 hover:text-slate-200' }}' : '{{ request()->routeIs('admin.dashboard') ? 'bg-rose-50 text-rose-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}']">
                            ...
                            <span x-show="!collapsed" x-transition:enter="transition-opacity ease-out duration-200 delay-[180ms]" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-in duration-[80ms]" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="truncate overflow-hidden whitespace-nowrap">Quản trị hệ thống</span>
                        </a>
                        ...
                        <a href="{{ route('admin.taxonomy') }}" wire:navigate :title="collapsed ? 'Cấu trúc Đào tạo' : null"
                           ...
                           :class="[collapsed ? 'justify-center' : '', dark ? '{{ request()->routeIs('admin.taxonomy') ? 'bg-rose-500/10 text-rose-400' : 'text-slate-400 hover:bg-slate-700/50 hover:text-slate-200' }}' : '{{ request()->routeIs('admin.taxonomy') ? 'bg-rose-50 text-rose-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}']">
                            ...
                            <span x-show="!collapsed" x-transition:enter="transition-opacity ease-out duration-200 delay-[180ms]" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-in duration-[80ms]" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="truncate overflow-hidden whitespace-nowrap">Cấu trúc Đào tạo</span>
                        </a>
                        ...
                        <a href="{{ route('admin.users') }}" wire:navigate :title="collapsed ? 'Người dùng' : null"
                           ...
                           :class="[collapsed ? 'justify-center' : '', dark ? '{{ request()->routeIs('admin.users') ? 'bg-rose-500/10 text-rose-400' : 'text-slate-400 hover:bg-slate-700/50 hover:text-slate-200' }}' : '{{ request()->routeIs('admin.users') ? 'bg-rose-50 text-rose-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}']">
                            ...
                            <span x-show="!collapsed" x-transition:enter="transition-opacity ease-out duration-200 delay-[180ms]" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-in duration-[80ms]" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="truncate overflow-hidden whitespace-nowrap">Quản lý người dùng</span>
                        </a>
                        ...
                        <a href="{{ route('admin.audit') }}" wire:navigate :title="collapsed ? 'Nhật ký hoạt động' : null"
                           ...
                           :class="[collapsed ? 'justify-center' : '', dark ? '{{ request()->routeIs('admin.audit') ? 'bg-rose-500/10 text-rose-400' : 'text-slate-400 hover:bg-slate-700/50 hover:text-slate-200' }}' : '{{ request()->routeIs('admin.audit') ? 'bg-rose-50 text-rose-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}']">
                            ...
                            <span x-show="!collapsed" x-transition:enter="transition-opacity ease-out duration-200 delay-[180ms]" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-in duration-[80ms]" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="truncate overflow-hidden whitespace-nowrap">Nhật ký hoạt động</span>
                        </a>
                    @endcan
